...
// Simplified interface - only need symbol for navigation
      ...
      {totalFilteredPages > 1 && (
        <div className="flex justify-center items-center space-x-2 mt-6">
          ...
          <button
            ...
            className="px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            style={{
              backgroundColor: currentPage === totalFilteredPages ? 'var(--sidebar-bg)' : 'var(--sidebar-hover)',
              color: 'var(--foreground)',
            }}
          >
            Next
